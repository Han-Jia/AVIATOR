...
class MAML_FC_regression(nn.Module):
    ...
    def __init__(self, args):
        ...
        self.fc1 = nn.Linear(self.h_dim+1, 128)
        self.fc2 = nn.Linear(128, self.h_dim+1) # 1 for bias
    ...
    def forward(self, data_shot, data_query, label_shot):
        ...
        combined_input = (support.transpose(0, 1).mm(support)+torch.eye(support.size(1))).inverse()\
